...
def EvalRes(filename,outevalname):
    target_wd = 40
    target_ht = 40
    img_list = []
    sizeoftype = 6400
    ...
    Fout = open(outevalname,"w")
    for i, data in enumerate(train_data):
        data = data.as_in_context(ctx)
        output = netD(data).softmax(axis=1).asnumpy()
        output.tofile(Fout)
    Fout.close()

EvalRes("./OUTS/QCD/TEST/4/image","./OUTS/QCD/TEST/4/DCGAN_RESPONSE")
EvalRes("./OUTS/QCD/TEST/5/image","./OUTS/QCD/TEST/5/DCGAN_RESPONSE")
EvalRes("./OUTS/QCD/TEST/6/image","./OUTS/QCD/TEST/6/DCGAN_RESPONSE")
EvalRes("./OUTS/QCD/TEST/7/image","./OUTS/QCD/TEST/7/DCGAN_RESPONSE")
EvalRes("./OUTS/QCD/TEST/0/image","./OUTS/QCD/TEST/0/DCGAN_RESPONSE")
EvalRes("./OUTS/QCD/TEST/1/image","./OUTS/QCD/TEST/1/DCGAN_RESPONSE")
EvalRes("./OUTS/QCD/TEST/2/image","./OUTS/QCD/TEST/2/DCGAN_RESPONSE")
EvalRes("./OUTS/QCD/TEST/3/image","./OUTS/QCD/TEST/3/DCGAN_RESPONSE")

EvalRes("./OUTS/TOP/TEST/4/image","./OUTS/TOP/TEST/4/DCGAN_RESPONSE")
EvalRes("./OUTS/TOP/TEST/5/image","./OUTS/TOP/TEST/5/DCGAN_RESPONSE")
EvalRes("./OUTS/TOP/TEST/6/image","./OUTS/TOP/TEST/6/DCGAN_RESPONSE")
EvalRes("./OUTS/TOP/TEST/7/image","./OUTS/TOP/TEST/7/DCGAN_RESPONSE")
EvalRes("./OUTS/TOP/TEST/0/image","./OUTS/TOP/TEST/0/DCGAN_RESPONSE")
EvalRes("./OUTS/TOP/TEST/1/image","./OUTS/TOP/TEST/1/DCGAN_RESPONSE")
EvalRes("./OUTS/TOP/TEST/2/image","./OUTS/TOP/TEST/2/DCGAN_RESPONSE")
EvalRes("./OUTS/TOP/TEST/3/image","./OUTS/TOP/TEST/3/DCGAN_RESPONSE")
