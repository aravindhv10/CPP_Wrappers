...
////////////////////////////////////////////////////////////////
#define _MACRO_SIMPLE_GEMM_CALL_(FLOAT_TYPE,GEMM_NAME)  \
        template <                                      \
            size_t X, size_t Y, size_t Z                \
        > inline void My_GEMM_N_N (                     \
            FLOAT_TYPE const alpha  ,                   \
            NN::N2D_ARRAY <X,Z,FLOAT_TYPE> const & A ,  \
            NN::N2D_ARRAY <Z,Y,FLOAT_TYPE> const & B ,  \
            FLOAT_TYPE const beta   ,                   \
            NN::N2D_ARRAY <X,Y,FLOAT_TYPE>       & C    \
        ) {                                             \
            GEMM_NAME (                                 \
                CblasRowMajor ,                         \
                CblasNoTrans , CblasNoTrans  ,          \
                /* OPENBLAS_CONST blasint M = */ X ,    \
                /* OPENBLAS_CONST blasint N = */ Y ,    \
                /* OPENBLAS_CONST blasint K = */ Z ,    \
                alpha ,                                 \
                A.GET_DATA() , A.SIZE_X() ,             \
                B.GET_DATA() , B.SIZE_X() ,             \
                beta , C.GET_DATA() , C.SIZE_X()        \
            ) ;                                         \
        } //////////////////////////////////////////////////////
_MACRO_SIMPLE_GEMM_CALL_(float,cblas_sgemm)
_MACRO_SIMPLE_GEMM_CALL_(double,cblas_dgemm)
#undef _MACRO_SIMPLE_GEMM_CALL_
////////////////////////////////////////////////////////////////
...
#define _MACRO_SIMPLE_GEMM_CALL_(FLOAT_TYPE,GEMM_NAME)  \
        template <                                      \
            size_t X, size_t Y, size_t Z                \
        > inline void My_GEMM_T_N (                     \
            FLOAT_TYPE const alpha  ,                   \
            NN::N2D_ARRAY <Z,X,FLOAT_TYPE> const & A ,  \
            NN::N2D_ARRAY <Z,Y,FLOAT_TYPE> const & B ,  \
            FLOAT_TYPE const beta   ,                   \
            NN::N2D_ARRAY <X,Y,FLOAT_TYPE>       & C    \
        ) {                                             \
...
#define _MACRO_SIMPLE_GEMM_CALL_(FLOAT_TYPE,GEMM_NAME)  \
        template <                                      \
            size_t X, size_t Y, size_t Z                \
        > inline void My_GEMM_N_T (                     \
            FLOAT_TYPE const alpha  ,                   \
            NN::N2D_ARRAY <X,Z,FLOAT_TYPE> const & A ,  \
            NN::N2D_ARRAY <Y,Z,FLOAT_TYPE> const & B ,  \
            FLOAT_TYPE const beta   ,                   \
            NN::N2D_ARRAY <X,Y,FLOAT_TYPE>       & C    \
        ) {                                             \
            GEMM_NAME (                                 \
...
////////////////////////////////////////////////////////////////
    ...
    namespace FUNCTIONS /* The neural network multiplication function: */ {
        ...
        NeuralMultiply (
            ...
            { Output[b] = Bias ; }
            //
            My_GEMM_N_T (1.0,Input,Weight,1.0,Output) ;
            if(false){
                cblas_dgemm (
