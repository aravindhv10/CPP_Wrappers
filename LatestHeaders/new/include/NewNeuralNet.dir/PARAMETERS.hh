#ifndef _HEADER_GUARD_NewNeuralNet_PARAMETERS_
#define _HEADER_GUARD_NewNeuralNet_PARAMETERS_
    ...
    namespace THREADED_NN {
        ...
        public:
			...
			operator >> (
				...
				file.multiwrite2file(W);
				file.multiwrite2file(B);
			}
			...
			operator << (
				...
				//printf("Came to Read...\n");
				file.multiread2file(W);
				file.multiread2file(B);
			}
