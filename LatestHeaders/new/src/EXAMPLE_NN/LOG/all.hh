...
namespace BASIC {
	...
	using TYPE_LN1 =
		NewNeuralNet::NN_GRAD::LinearLayer <
			SIZE_B()	,
			SIZE_Z()	,
			SIZES[1]	,
			SIZES[0]	,
	...
	public:
		...
		inline void
		Randomize () {
			NewNeuralNet::FUNCTIONS::RANDOMIZE(W1);
			NewNeuralNet::FUNCTIONS::RANDOMIZE(W2);
			NewNeuralNet::FUNCTIONS::RANDOMIZE(W3);
			NewNeuralNet::FUNCTIONS::RANDOMIZE(B1);
			NewNeuralNet::FUNCTIONS::RANDOMIZE(B2);
			NewNeuralNet::FUNCTIONS::RANDOMIZE(B3);
		}
...
#define _MACRO_LL_(SIZE_Y,SIZE_X)					\
													\
	NewNeuralNet::THREADED_NN_GRAD::LinearLayer <	\
		SIZE_T()	,	SIZE_B()	,				\
		SIZE_Z()	,	SIZE_Y		,				\
		SIZE_X		,	TYPE_DATA					\
	>												\
...
#define _MACRO_LA_(SIZE_Y)						\
												\
	NewNeuralNet::THREADED_NN_GRAD::SoftLRU <	\
		SIZE_T()	,	SIZE_B()	,			\
		SIZE_Z()	,	SIZE_Y		,			\
		TYPE_DATA								\
	>											\
