...
namespace RNN {
    ...
    public:
        NeuralNetworks::Parameters <3> pars ;
    ...
    //typedef JetStore < NeuralNetworks::GoodAdamizeMatrix , NeuralNetworks::GoodAdamizeVector > JetRNN ;
    typedef JetStore < NeuralNetworks::GoodAdaRegMatrix  , NeuralNetworks::GoodAdaRegVector  > JetRNN ;
    ...
    private:
        ...
        inline void Analyze (HEPTopTagger::TopTagger&MainTagger) {
            ...
            network.Input()(18) = MainTagger.ClosestB       ;
            network.Input()(19) = MainTagger.HTT_Tagged     ;
