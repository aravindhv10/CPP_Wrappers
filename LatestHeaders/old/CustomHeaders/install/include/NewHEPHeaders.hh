...
namespace NewHEPHeaders {
    ...
    public:
        ...
        inline plane2vector <TR> operator +  (plane2vector <TR> b) { return plane2vector <TR> (x[0]+b.x[0],x[1]+b.x[1]) ; }
        inline plane2vector <TR> operator -  (plane2vector <TR> b) { return plane2vector <TR> (x[0]-b.x[0],x[1]-b.x[1]) ; }
        inline TR                operator *  (plane2vector <TR> b) { return (x[0]*b.x[0]) + (x[1]*b.x[1]) ; }
        inline plane2vector <TR> operator *  (TR b)                { return plane2vector <TR> (x[0]*b,x[1]*b) ; }
        inline plane2vector <TR> operator /  (TR b)                { return plane2vector <TR> (x[0]/b,x[1]/b) ; }

        inline double  operator () (plane2vector <TR> b) { return dphi (b) ; }

        inline plane2vector <TR> flip  () { return plane2vector <TR> ( -x[0] , -x[1] ) ; }
    ...
    public:
        ...
        inline euclid3vector <TR> operator +  ( euclid3vector <TR> a ) { return euclid3vector <TR> (xy+a.xy,z+a.z) ; }
        inline euclid3vector <TR> operator -  ( euclid3vector <TR> a ) { return euclid3vector <TR> (xy-a.xy,z-a.z) ; }
        inline TR                 operator *  ( euclid3vector <TR> a ) { return (xy*a.xy) + (z*a.z)                ; }
        inline euclid3vector <TR> operator *  ( TR a )                 { return euclid3vector <TR> (xy*a,z*a)      ; }
        inline euclid3vector <TR> operator /  ( TR a )                 { return euclid3vector <TR> (xy/a,z/a)      ; }
        ...
        inline double cone (euclid3vector <TR> b) { return sqrt(cone2(b)) ; }
    ...
    public:
        ...
        TR t ;
        lorentz4vector ( TR _x=0 , TR _y=0 , TR _z=0 , TR _t=-1 ) : xyz(_x,_y,_z) {t=_t;}
        lorentz4vector ( const euclid3vector  <TR> a , TR _t=-1 ) : xyz(a)        {t=_t;}
        ...
        inline lorentz4vector <TR> operator + (lorentz4vector <TR> b) { return lorentz4vector <TR> ( xyz+b.xyz , t+b.t ) ; }
        inline lorentz4vector <TR> operator - (lorentz4vector <TR> b) { return lorentz4vector <TR> ( xyz-b.xyz , t-b.t ) ; }
        ...
        inline lorentz4vector <TR> LorentzBoost ( euclid3vector <TR> booster ) {
            //euclid3vector <TR> direction = booster.dir () ;
            //euclid3vector <TR> parallel  = direction * ( xyz * direction ) ;
            euclid3vector <TR> parallel  = booster * ( ( xyz * booster ) / booster.p2() ) ;
            euclid3vector <TR> perpendicular = xyz - parallel ;
            double gm = booster.p2 () ; gm = 1.0 - gm ; gm = (1.0/gm) ; gm = sqrt(gm) ;
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////
    typedef plane2vector   <float> vector2 ;
    typedef euclid3vector  <float> vector3 ;
    typedef lorentz4vector <float> vector4 ;
    ////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    void cleanup_vectors (vector4s & thevectors) {
        ...
        for (size_t i=0;i<thevectors.size();i++) if(!thevectors[i].cleared()) {tmp_thevectors.push_back(thevectors[i]);}
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // The main element of the event class: ////////////////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    class pythia_node {
    private:
    public:
        ////////////////////////////////////////////////////////////////
        //The part that gets written to disk... careful not to change.//
        //////////////////////////////////////////////////////////////// {
        vector4 vec ;
        int d1, d2, pid;
        //////////////////////////////////////////////////////////////// }
        ...
        ////////////////////////////////////////////////////////////////
        ~pythia_node () {}
        pythia_node  () { d1=-1; d2=-1; pid=0; vec.clearthis(); }
        pythia_node ( float _x , float _y , float _z , float _t , int _d1 , int _d2 , int _pid ) : vec(_x,_y,_z,_t) {
            d1  = _d1  ;
            d2  = _d2  ;
            pid = _pid ;
        }
        pythia_node ( const Pythia8::Particle & part ) {
            vec = vector4 (part.px(),part.py(),part.pz(),part.e()) ;
            pid = part.id();
        ...
        inline float  px           () { return vec[0]                   ; }
        inline float  py           () { return vec[1]                   ; }
        inline float  pz           () { return vec[2]                   ; }
        inline float  e            () { return vec[3]                   ; }
        inline float  pt           () { return vec.pt()                 ; }
        inline float  eta          () { return vec.eta()                ; }
        ...
        inline vector4 & getvec    () { return vec                        ; }
        inline double operator     () (pythia_node b) { return vec(b.vec) ; }
        inline double pcone (pythia_node b) { return vec.pcone(b.vec) ; }
        inline fastjet::PseudoJet getpseudojet () { return vec.getpseudojet () ; }
    };
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // The class to hold delphes gen and detector info: ////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    class processed_data {
    private:
        template <typename T> void sortthis (T & refs) {
            sortorder mysort ;
            if (refs.size()>1) {std::sort(refs.begin(),refs.end(),mysort);}
        }
    public:
        ...
        processed_data  () {clearall();}
        ~processed_data () {}
        bool check_clean_leptons (vector4 lept) {
            for (size_t i=0;i<ajets.size();i++) if ((*(ajets[i]))(lept)<0.4) {return false;}
            return true ;
        }
        void cleanup_leptons ( vector4s & lepts ) {
            vector4s tmp ;
            for (size_t i=0;i<lepts.size();i++) if(check_clean_leptons(lepts[i])) {tmp.push_back(lepts[i]);}
        ...
        void JetPointer () {
            ...
            sortthis(bjets);
            ajets.clear();
            for (size_t i=0;i<njets.size();i++) {ajets.push_back(&njets[i]);}
            for (size_t i=0;i<bjets.size();i++) {ajets.push_back(&bjets[i]);}
            sortthis(ajets);
        }
        void LeptonPointer () {
            clean_all_leptons () ;
            sortthis (eln) ; sortthis (elp) ;
            sortthis (mun) ; sortthis (mup) ;
            lpn.clear();
            lpp.clear();
            lps.clear();
            for (size_t i=0;i<eln.size();i++) {lpn.push_back(&eln[i]);lps.push_back(&eln[i]);}
            for (size_t i=0;i<mun.size();i++) {lpn.push_back(&mun[i]);lps.push_back(&mun[i]);}
            for (size_t i=0;i<elp.size();i++) {lpp.push_back(&elp[i]);lps.push_back(&elp[i]);}
            for (size_t i=0;i<mup.size();i++) {lpp.push_back(&mup[i]);lps.push_back(&mup[i]);}
            sortthis (lpn) ;
            sortthis (lpp) ;
            sortthis (lps) ;
        }
        void RePt () {
            remet = vector4 (0,0,0,0) ; reht  = 0 ;
            for ( size_t i=0 ; i < lps.size   () ; i++ ) { remet = remet + ( * ( lps[i]   ) ) ; reht = reht + lps[i]->pt   () ; }
            for ( size_t i=0 ; i < ajets.size () ; i++ ) { remet = remet + ( * ( ajets[i] ) ) ; reht = reht + ajets[i]->pt () ; }
            for ( size_t i=0 ; i < gamma.size () ; i++ ) { remet = remet + (     gamma[i]   ) ; reht = reht + gamma[i].pt  () ; }
            mht = remet.pt() / reht ;
        }
        void prepare () {
            JetPointer    () ;
        ...
        template <typename T> bool ReadFromDelphes (T & delin) {
            ...
            for (int i=0;i<delin.Electron_;i++) {
                ...
                if      (delin.Electron_Charge[i]>0.001) {eln.push_back(tmp);}
                else if (delin.Electron_Charge[i]<0.001) {elp.push_back(tmp);}
            }
            for (int i=0;i<delin.Muon_;i++) {
                TLorentzVector v4ltmp ;
                v4ltmp.SetPtEtaPhiM(delin.Muon_PT[i],delin.Muon_Eta[i],delin.Muon_Phi[i],0);
                vector4 tmp (v4ltmp.Px(),v4ltmp.Py(),v4ltmp.Pz(),v4ltmp.E()) ;
                if      (delin.Muon_Charge[i]>0.001) {mun.push_back(tmp);}
                else if (delin.Muon_Charge[i]<0.001) {mup.push_back(tmp);}
            }
            for (int i=0;i<delin.Jet_;i++) {
                TLorentzVector v4ltmp ;
                v4ltmp.SetPtEtaPhiM(delin.Jet_PT[i],delin.Jet_Eta[i],delin.Jet_Phi[i],0);
                vector4 tmp (v4ltmp.Px(),v4ltmp.Py(),v4ltmp.Pz(),v4ltmp.E()) ;
                if (delin.Jet_BTag[i]==1) {bjets.push_back(tmp);}
                else                      {njets.push_back(tmp);}
            }
        ...
        double error_bestzmass () {
            double ret = 1000 ;
            if (ngoodleptons()>=2) {
                for (size_t i=0;i<elp.size();i++) for(size_t j=0;j<eln.size();j++) {
                    double tmp_mass = (elp[i]+eln[j]).m();
                    tmp_mass = CPPFileIO::mymod(tmp_mass-MASS::Z);
                    if (tmp_mass<ret) {ret=tmp_mass;}
                }
                for (size_t i=0;i<mup.size();i++) for(size_t j=0;j<mun.size();j++) {
        ...
        vector4 ReBuildW (double allower_error=15) {
            if (VectorW.pass()) {return VectorW;}
            double  BestWMass = 1000 ;
            vector4 BestWVector ; BestWVector.clearthis () ;
            vector4 *c1, *c2 ;
            for (size_t i=1;i<njets.size();i++) for (size_t j=0;j<i;j++) {
            ...
            if (BestWMass<allower_error) {
                //printf("DEBUG: W RECO ERROR: %e %e\n",BestWMass,BestWVector.m());
                VectorW = BestWVector ;
                if (BestWVector.m()>135) {printf("SCREWEEEEEEEEEDDDDDDDDDDDDDDD");}
                c1->clearthis();
                c2->clearthis();
                cleanup_vectors(njets);
                JetPointer();
            }
            else {BestWVector.clearthis();}
            return VectorW ;
        }
        vector4 ReBuildZ (double allower_error=15) {
            if (VectorZ.pass()) {return VectorZ;}
            double ret = 1000 ;
            vector4 *c1, *c2 ;
            vector4 Zvector ;
            char type = 'N' ;
    ...
    private:
        ...
        void clear_derived() {
            ...
            /* Clearing leptons: */ {
                elep.clear(); elen.clear();
                munp.clear(); munn.clear();
                leps.clear();
                plep.clear(); nlep.clear();
            }
            ht=0;
        }
        ////////////////////////////////////////////////////////////////
        ...
        double CalcIso          (size_t idx, double cone_rad = 0.3) { //////////////////////////////////////////////////////////////////
            ...
            if ( (idx>0) && (idx<store.size()) ) { /////////////////////////////////////////////////////////////////////////////////////
                for (size_t i=0;i<store.size();i++) if (i!=idx) if (store[i].IsGood()) if (store[i](store[idx])<cone_rad) {sum_pt=sum_pt+store[i].pt();}
        ...
        bool   IsIsolatedLepton (size_t idx) { /////////////////////////////////////////////////////////////////////////////////////////
            ...
            if (ret) {
                ...
                ret = (pt_ratio<0.3) && (store[idx].pt()>10.0) && (store[idx].modeta()<2.5) ;
            }
            return ret ;
        } //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        bool   IsIsolatedPhoton (size_t idx) { /////////////////////////////////////////////////////////////////////////////////////////
            return false ;
            bool ret = (store[idx].id()==PID::GAMMA) && (store[idx].IsGood()) ;
            if (ret) {
                double pt_ratio = CalcIso (idx,0.5) ;
                ret = (pt_ratio<0.12) && (store[idx].pt()>10.0) && (store[idx].modeta()<2.5) ;
            }
            return ret ;
        } //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        void makebjets () { ////////////////////////////////////////////////////////////////////////////////////////////////////////////
            vector4s NewBots ; CPPFileIO::clone_vector(bots,NewBots);
            for (size_t i=0;i<NewBots.size();i++) if ((NewBots[i].pt()<5)||(NewBots[i].meta()>5)) {NewBots[i].clearthis();}
            ...
            for(size_t k=0;(k<times)&&(repeater);k++) {
                ...
                size_t nearest_i = 0   ;
                size_t nearest_j = 0   ;
                for (size_t i=0;i<njets.size();i++) for (size_t j=0;j<NewBots.size();j++) if ((njets[i].pass())&&(NewBots[j].pass())) if (njets[i].meta()<2.5) {
    ...
    public:
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // The Part that gets written to the file... donot dare touch this lest u want the generated data to be wasted...///////////////
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        float pthat_min, pthat_max ; ///////////////////////////////////////////////////////////////////////////////////////////////////
        int   event_case           ; ///////////////////////////////////////////////////////////////////////////////////////////////////
        pythia_nodes store         ; ///////////////////////////////////////////////////////////////////////////////////////////////////
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ssize_t operator >> ( CPPFileIO::FileFD & f ) { ////////////////////////////////////////////////////////////////////////////////
            ssize_t ret = 0 ;
            ret = ret + ( f.multiwrite2file (pthat_min)  ) ;
            ret = ret + ( f.multiwrite2file (pthat_max)  ) ;
            ret = ret + ( f.multiwrite2file (event_case) ) ;
            ret = ret + ( f << store ) ;
            return ret ;
        } //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ssize_t operator << ( CPPFileIO::FileFD & f ) { ////////////////////////////////////////////////////////////////////////////////
            ssize_t ret = 0 ;
            ret = ret + ( f.multiread2file (pthat_min)  ) ;
            ret = ret + ( f.multiread2file (pthat_max)  ) ;
            ret = ret + ( f.multiread2file (event_case) ) ;
            ret = ret + ( f >> store ) ;
            return ret ;
        } //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // The parts which store processed data: ///////////////////////////////////////////////////////////////////////////////////////
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // Some important and convinent functions: /////////////////////////////////////////////////////////////////////////////////////
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        size_t getdaughter (size_t idx, long pid) { ////////////////////////////////////////////////////////////////////////////////////
            ...
            if (idx>0) {
                ...
                size_t d2 = store[idx].daughter2 () ;
                if ( (d1>0) || (d2>0) ) {
                    if (d2>d1) for ( size_t i=d1 ; (i>=d1) && (i<=d2) && (i>0) ; i++ ) {
        ...
        double error_bestzmass () { ////////////////////////////////////////////////////////////////////////////////////////////////////
            double ret = 1000 ;
            if (ngoodleptons()>=2) {
                for (size_t i=0;i<elep.size();i++) for(size_t j=0;j<elen.size();j++) {
                    double tmp_mass = (elep[i]+elen[j]).m();
                    tmp_mass = CPPFileIO::mymod(tmp_mass-MASS::Z);
                    if (tmp_mass<ret) {ret=tmp_mass;}
                }
                for (size_t i=0;i<munp.size();i++) for(size_t j=0;j<munn.size();j++) {
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // The main function which reconstructs objects from gen information: //////////////////////////////////////////////////////////
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        void prepare () { //////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ////////////////////////////////////////////////////////////////
            ...
            /* Get the bottoms: */ {
                ...
                for (size_t i=0;i<EVT_SZ;i++) if ( CPPFileIO::mymod (store[i].id()) == PID::BOTTOM ) {
            ...
            ////////////////////////////////////////////////////////////////
            for(size_t i=0;i<EVT_SZ;i++) if(store[i].IsGood()) {
                ...
                if  (IsIsolatedLepton(i)) {
                    ...
                    if (tmp_pid>0) {plep.push_back(tmp);}
                    else           {nlep.push_back(tmp);}
                         if(tmp_pid==PID::ELECTRON)  {elep.push_back(tmp);gendata.elp.push_back(tmp);}
                    else if(tmp_pid==-PID::ELECTRON) {elen.push_back(tmp);gendata.eln.push_back(tmp);}
                    else if(tmp_pid==PID::MUON)      {munp.push_back(tmp);gendata.mup.push_back(tmp);}
                    else if(tmp_pid==-PID::MUON)     {munn.push_back(tmp);gendata.mun.push_back(tmp);}
                }
                else if ( IsIsolatedPhoton(i) ) { gamma.push_back (tmp) ; gendata.gamma.push_back (tmp) ; }
                else { hads.push_back (tmp) ; }
            }
            met = met.flip().trans();
            ////////////////////////////////////////////////////////////////
            getfastjet(); makenjets(); makebjets();
            if(leps.size()>1) {std::sort(leps.begin(),leps.end());}
            for (size_t i=0;i<njets.size();i++) {gendata.njets.push_back(njets[i]);}
            for (size_t i=0;i<bjets.size();i++) {gendata.bjets.push_back(bjets[i]);}
            gendata.met = met ;
            gendata.ht  = ht  ;
            gendata.prepare() ;
            ////////////////////////////////////////////////////////////////
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        inline pseudojets & getjetref () {return tojets;} 
        ...
        eventstore () {} ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        eventstore ( Pythia8::Event & event ) {FromPythia(event);} /////////////////////////////////////////////////////////////////////
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ~eventstore () {} 
    ...
    public:
        ...
        reco_top_had ( vector4 & _njet0 , vector4 & _njet1 , vector4 & _bjet ) {
            ...
            top.clearthis();
            w.clearthis();
            njet[0] = & _njet0 ; njet[1] = & _njet1 ; bjet = & _bjet ;
            if ( (!njet[0]->cleared()) && (!njet[1]->cleared()) && (!bjet->cleared()) ) {
                w    = (*njet[0]) + (*njet[1]) ;
                top  = w          + (*bjet)    ;
                pass = true                    ;
            }
    ...
    public:
        ...
        reco_top_lept ( vector4 & _lept , vector4 & _met , vector4 & _bjet ) {
            ...
            if (dis>0) {
                pnu[0][2] = (-b+sqrt(dis))/(2.0*a) ; pnu[0][3] = pnu[0].p() ;
                pnu[1][2] = (-b-sqrt(dis))/(2.0*a) ; pnu[1][3] = pnu[1].p() ;
                ...
                if (diff0>diff1) {CPPFileIO::myswap(pnu[0],pnu[1]);}
                w    = (pnu[0]) + (*lept) ;
                top  = w        + (*bjet) ;
                pass = true               ;
                // printf("DEBUG: WMASS = %e\n",w.m());
                if(CPPFileIO::mymod(w.m()-MASS::W)>1.0) {printf("ERROR: Something has gone blatently wrong... W Mass error \n");}
            }
            else { clearthis () ; }
        }
        void clearthis() {
    ...
    void LHA2HEPMC ( std::string lhafile , std::string hepmcfile ) { ///////////////////////////////////////////////////////////////
        ...
        std::string tmp ("Beams:LHEF = ") ; tmp = tmp + lhafile ;
        pythia.readString (&(tmp[0])) ;
        pythia.init () ;
        for ( size_t iEvent=0 ; (!pythia.info.atEndOfFile()) ; iEvent++ ) if (pythia.next()) {outfile(pythia);}
        pythia.stat();
    }
    
    // New Convinent Awesome Histogram Class: //////////////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    class myhist { /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    private:
        ////////////////////////////////
        ...
        bool convert_hist () {
            ...
            if ( (nums>1) && (!converted) ) {
                ...
                for (size_t ii=0;ii<nums;ii++) {thehist->Fill(vals[ii]);}
                vals.clear();
                converted = true ;
            }
            return converted ;
        ...
        bool write_histogram () {
            if (!converted) {convert_hist();}
            if (converted)  {
                thehist->Write();
                delete thehist ;
            }
            else {printf("ERROR: Something went horribly wrong... %s\n",&(name[0]));vals.clear();}
        }
        void fill (float val) {
            if(converted) {thehist->Fill(val);}
            else {
                vals.push_back(val);
                if(vals.size()>10000) {convert_hist();}
            }
        }
        ////////////////////////////////
        ////////////////////////////////
    ...
    public:
        ...
        ////////////////////////////////
        size_t N_Bins_Max ;
        myhist (std::string _name) : name(_name) , converted(false) {vals.clear();N_Bins_Max=100;}
        ~myhist () {write_histogram();}
        inline void Fill (float val) {fill(val);}
        inline std::string get_name () {return name; }
        bool force_convert_hist ( size_t nbins , float hist_begin , float hist_end ) {
            if ( !converted ) {
                std::sort (vals.begin(),vals.end());
                thehist = new TH1F (&(name[0]),&(name[0]),nbins,hist_begin,hist_end) ;
                for (size_t ii=0;ii<vals.size();ii++) {thehist->Fill(vals[ii]);}
                vals.clear();
                converted = true ;
            }
            return converted ;
    ...
    public:
        myhist pt, eta, phi, m ;
        VectorHist (std::string name) :
        pt  ( name + std::string (":pt")  ) , eta ( name + std::string (":eta")  ) ,
        phi ( name + std::string (":phi") ) , m   ( name + std::string (":mass") ) ,
        vectorname(name) {}
        ~VectorHist(){}
    ...
    public:
        bool normalized ;
        MultiPlot(std::string rootfilename,std::string _title) : rootfile(&(rootfilename[0])) , title(_title) {normalized=false;maxy=0;}
        ~MultiPlot(){
            for ( size_t i=0 ; i<hists.size() ; i++ ) {delete hists[i];}
        }
        void operator () (std::string histname) {
            TH1F *tmphist=(TH1F*)rootfile.Get(&(histname[0]));
            if (tmphist!=NULL) {
                if(normalized){double factor=tmphist->Integral();tmphist->Scale(1.0/factor);}
    ...
    private:
        ...
        inline void copyfrom (const flowtable & other) {
            ...
            while ( names.size() < L.size() + 1 ) { names.push_back (std::string("nothing")) ; }
    ...
    public:
        ...
        ////////////////////////////////////////////////////////////////
        void startover () {current=0;}
        void fill (bool val=true, std::string name = "noothing") {
            while ( L.size()     < current + 1 ) { L.push_back     (0)    ; }
            while ( names.size() < current + 1 ) { names.push_back (name) ; }
            if (val) {L[current]++;}
            names[current] = name ;
            current++ ;
        }
    ...
    private:
        ...
        void attachtable ( const flowtable & other , double _sigma = 1.0 ) {thetables.push_back(flowtable(other));sigmas.push_back(_sigma);}
        void showtable (FILE *fout) {
            size_t max_v=0; for (size_t i=0;i<thetables.size();i++) {max_v=CPPFileIO::mymax(max_v,thetables[i].L.size());}
            for (size_t i=0;i<thetables.size();i++) while (thetables[i].L.size()<max_v) {thetables[i].L.push_back(0);}
            size_t min_h = CPPFileIO::mymin (thetables.size(),titles.size()) ;
            /* The first declaration line: */ {
                fprintf(fout,"\\begin{tabular}{");
                for(size_t i=0;i<min_h+1;i++){fprintf(fout,"|c");}
                fprintf(fout,"|}\n");
            }
            /* The second titles line: */ {
                fprintf(fout,"\\hline Event type:");
                for (size_t i=0;i<min_h;i++) {fprintf(fout," & %s ",&(titles[i][0]));}
                fprintf(fout,"\\\\\n");
            }
            /* The third sigmas line: */ {
                fprintf(fout,"\\hline $\\sigma$  :");
                for (size_t i=0;i<min_h;i++) {fprintf(fout," & %e ",sigmas[i]);}
                fprintf(fout,"\\\\\n");
            }
            for (size_t j=0;j<max_v;j++) {
                ...
                for (size_t i=0;i<min_h;i++) {
                    fprintf (
                        fout ,
                        " & %ld (%.3e) " ,
                             thetables[i].L[j] , (double) ((double)thetables[i].L[j]*sigmas[i]) / thetables[i].L[0]
                    );
                }
                fprintf(fout,"\\\\\n");
            }
    ...
    public:
        ...
        inline void operator () (const flowtable & other , double _sigma = 1.0 ) {attachtable(other,_sigma);}
    }; 
}
