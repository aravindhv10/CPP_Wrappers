...
public:
    ...
    typedef T TYPE_DATA ;
    //
    typedef std::complex <TYPE_DATA>
        TYPE_COMPLEX_DATA
    ; //
    //
    typedef Tensors::NN::ND_ARRAY
        <4,TYPE_COMPLEX_DATA>
            TYPE_MAIN_VECTOR
    ; //
    //
    typedef Tensors::NN::N2D_ARRAY
    ...
    static inline TYPE_COMPLEX_DATA
    DAGGER (
        TYPE_COMPLEX_DATA const in
    ) { return std::conj (in) ; }
    //
    static inline TYPE_MAIN_VECTOR
    DAGGER (
        TYPE_MAIN_VECTOR const & in
    ) {
    ...
    PROPAGATOR (
        ...
        return PROPAGATOR(NORM2(p).real(),m,w);
    }
    ////////////////////////////////
    ...
    //
    static inline TYPE_MAIN_MATRIX
    FERMION_PROPAGATOR_V (
        TYPE_MAIN_VECTOR const & p         ,
        TYPE_DATA        const   m = 0     ,
        TYPE_DATA        const   w = EPS()
    ) {
        return MULTIPLY (
            FERMION_NUMERATOR_V(p,m),
            PROPAGATOR(p,m,w)
        ) ;
    }
    //
